        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Format = table.Column<string>(type: "varchar(4)", nullable: true),
                    ExternalApplicationId = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DocumentTypes_ExternalApplications_ExternalApplicationId",
            ...
            migrationBuilder.CreateTable(
                name: "DocumentMatchings",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ExternalId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    CentralizedDocumentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(128)", nullable: true),
                    LastModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DocumentMatchings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DocumentMatchings_Documents_CentralizedDocumentId",
                        column: x => x.CentralizedDocumentId,
                        principalTable: "Documents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentMatchings_CentralizedDocumentId",
                table: "DocumentMatchings",
                column: "CentralizedDocumentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_DocumentMatchings_CentralizedDocumentId_ExternalId",
                table: "DocumentMatchings",
                columns: new[] { "CentralizedDocumentId", "ExternalId" },
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocumentTypes_ExternalApplicationId",
                table: "DocumentTypes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalApplications_Name",
